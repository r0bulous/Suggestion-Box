...
namespace SuggestionBox.Controllers
{
    public class SuggestionModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RecordNumber,Topic,Suggestion")] SuggestionModel suggestionModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RecordNumber,Topic,Suggestion")] SuggestionModel suggestionModel)
        {
            if (ModelState.IsValid)
            {
